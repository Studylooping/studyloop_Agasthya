  ...
  const unletteredChoices = LETTERS.map((seedLetter, choiceIndex) => {
    ...
    return {
      ...
      misconceptionTag: isCorrect
        ? null
        : seed.misconceptionTags?.[seedLetter] ?? "incorrect_cbse_lpp_reasoning",
    };
  });
...
const halfPlaneFigure: ItemFigure = {
  ...
  description: "The boundary line x plus y equals 6 with the feasible side below the line in the first quadrant.",
  svg: `
...
const feasibleRegionFigure: ItemFigure = {
  ...
  description: "Feasible region for x plus y at most 6, x plus 2y at most 8, and non-negative variables.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const balancedConstraintFigure: ItemFigure = {
  ...
  description: "Feasible region for 2x plus y at most 8, x plus 2y at most 8, and non-negative variables.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const unboundedRegionFigure: ItemFigure = {
  ...
  description: "Unbounded feasible region for x plus y at least 4 with non-negative variables.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const multipleOptimaFigure: ItemFigure = {
  ...
  description: "Triangular feasible region where the objective line is parallel to an optimal boundary edge.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const productionRegionFigure: ItemFigure = {
  ...
  description: "Feasible region for a production problem with constraints x plus y at most 50 and 2x plus 3y at most 120.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const lppTerminologyFigure: ItemFigure = {
  ...
  description: "A sample feasible region with labels connecting decision variables, constraints, objective function, and optimal solution.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const applicationProfitFigure: ItemFigure = {
  ...
  description: "Feasible region for 2x plus y at most 100, x plus y at most 80, and non-negative variables.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const applicationSaqFigure: ItemFigure = {
  ...
  description: "Feasible region for x plus y at most 10, x plus 2y at most 14, and non-negative variables.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const applicationMinimumFigure: ItemFigure = {
  ...
  description: "Unbounded feasible region for x plus y at least 5, 2x plus y at least 8, and non-negative variables.",
  svg: `
<svg viewBox="0 0 560 360" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="560" height="360" rx="12" fill="#f8fafc"/>
  <defs>
...
const machineHoursFigure: ItemFigure = {
  ...
  description: "Two products with machine-hour use and a total machine-hour availability.",
  svg: `
...
const topicSeeds: readonly TopicSeed[] = [
  {
    ...
    subtopic: "Decision variables, objective function, constraints, feasible solutions, and non-negativity conditions",
    mc: [
      {
        questionLatex:
        ...
        correctLetter: "B",
        hints: ["The objective function is the expression to be maximized or minimized.", "Constraints restrict the possible values.", "Here the word $\\max$ identifies the objective."],
        solution: [{ step: 1, explanation: "The expression being maximized is $Z=40x+30y$.", math: "Z=40x+30y" }],
      },
      {
        questionLatex:
        ...
        choices: ["$x+y\\ge0$", "$x\\le0,\\ y\\le0$", "$x\\ge0,\\ y\\ge0$", "$x-y\\ge0$"],
        correctLetter: "C",
        hints: ["Product numbers cannot be negative.", "Non-negativity is applied to each decision variable separately.", "Write two inequalities."],
        solution: [{ step: 1, explanation: "Numbers of products cannot be negative, so $x\\ge0$ and $y\\ge0$.", math: "x\\ge0,\\quad y\\ge0" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "C",
        hints: ["The phrase 'at least' means minimum.", "A minimum requirement uses $\\ge$.", "Total items are $x+y$."],
        solution: [{ step: 1, explanation: "'At least 20' means the total cannot be below 20, so $x+y\\ge20$.", math: "x+y\\ge20" }],
      },
      {
        questionLatex:
        ...
        difficulty: 3,
        skillTags: ["formulation", "constraints"],
        choices: ["$2x+3y\\le60$", "$3x+2y\\le60$", "$2x+3y\\ge60$", "$x+y\\le60$"],
        correctLetter: "A",
        hints: ["Multiply each product count by its hour use.", "Available hours give an upper limit.", "Use $\\le$."],
        solution: [{ step: 1, explanation: "Total machine hours used are $2x+3y$, and they cannot exceed $60$.", math: "2x+3y\\le60" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "A",
        hints: ["Substitute each point in all constraints.", "A feasible point must satisfy every inequality.", "Check non-negativity also."],
        solution: [{ step: 1, explanation: "$(2,3)$ gives $2+3=5\\le6$ and $2(2)+3=7\\le7$, with both coordinates non-negative.", math: "(2,3)\\text{ is feasible}" }],
      },
    ],
    constructed: [
      {
        ...
        hints: ["Multiply each item count by its profit.", "Add the two profit contributions.", "Use $P$ or $Z$ for the objective."],
        rubric: singleRubric("a", 2, "Writes $P=50x+80y$."),
        commonErrors: ["Writing a constraint instead of the profit function."],
        workedSolution: [{ part: "a", explanation: "Total profit is $P=50x+80y$." }],
      },
      {
        responseType: "vsaq",
        questionLatex:
        ...
        hints: ["Counts cannot be negative.", "Apply this to both variables.", "Use $\\ge0$."],
        rubric: singleRubric("a", 2, "States $x\\ge0, y\\ge0$."),
        commonErrors: ["Writing only $x+y\\ge0$, which is weaker than both counts being non-negative."],
        workedSolution: [{ part: "a", explanation: "Since both variables count items, $x\\ge0$ and $y\\ge0$." }],
      },
      {
        responseType: "saq",
        questionLatex:
        ...
        parts: singlePart("a", "Let $x$ be tables and $y$ be stools. Write the wood constraint and profit function.", 3),
        hints: ["Wood used is $3x+y$.", "At most means $\\le$.", "Profit is $120x+50y$."],
        rubric: {
          maxPoints: 3,
          criteria: [
            { part: "a", points: 1, description: "Defines or uses $x,y$ correctly." },
        ...
        workedSolution: [{ part: "a", explanation: "If $x$ is tables and $y$ is stools, the wood constraint is $3x+y\\le90$ and the profit function is $P=120x+50y$." }],
      },
      {
        responseType: "laq",
        questionLatex:
        ...
        skillTags: ["formulation", "constraints", "objective_function"],
        parts: [
          { letter: "a", promptMarkdown: "Define the decision variables.", points: 1 },
          { letter: "b", promptMarkdown: "Write all constraints.", points: 3 },
          { letter: "c", promptMarkdown: "Write the objective function.", points: 1 },
        ],
        hints: ["Use $x,y$ for numbers of guides.", "Budget, shelf capacity, minimum mathematics guides, and non-negativity are all constraints.", "The score is to be maximized."],
        rubric: {
          maxPoints: 5,
          criteria: [
            { part: "a", points: 1, description: "Defines $x,y$ as guide counts." },
            { part: "b", points: 1, description: "Writes budget constraint $300x+200y\\le12000$." },
            { part: "b", points: 1, description: "Writes shelf and minimum constraints $x+y\\le50, x\\ge10$." },
            { part: "b", points: 1, description: "Includes $x,y\\ge0$." },
            { part: "c", points: 1, description: "Writes maximize $Z=6x+5y$." },
          ],
        },
        commonErrors: ["Forgetting the minimum condition $x\\ge10$.", "Writing the budget as an equality without reason."],
        workedSolution: [
          { part: "a", explanation: "Let $x$ be the number of mathematics guides and $y$ be the number of science guides." },
          { part: "b", explanation: "The constraints are $300x+200y\\le12000$, $x+y\\le50$, $x\\ge10$, $x\\ge0$, and $y\\ge0$." },
      ...
      },
      {
        ...
        difficulty: 4,
        skillTags: ["formulation", "constraints", "objective_function", "case_based"],
        parts: [
          { letter: "a", promptMarkdown: "Write the preparation-time constraint.", points: 1 },
          { letter: "b", promptMarkdown: "Write the item-capacity and non-negativity constraints.", points: 1 },
          { letter: "c", promptMarkdown: "Write the objective function to maximize profit.", points: 2 },
        ],
        hints: ["Preparation time comes from $2x+y$.", "At most gives $\\le$.", "Profit is earned per item sold."],
        rubric: {
          maxPoints: 4,
          criteria: [
            { part: "a", points: 1, description: "Writes $2x+y\\le100$." },
            { part: "b", points: 1, description: "Writes $x+y\\le70$ and $x,y\\ge0$." },
            { part: "c", points: 2, description: "Writes maximize $P=12x+8y$." },
          ],
        },
        commonErrors: ["Using $x+y\\le100$ for time instead of $2x+y\\le100$.", "Leaving out non-negativity constraints."],
        workedSolution: [
          { part: "a", explanation: "Preparation time gives $2x+y\\le100$." },
          { part: "b", explanation: "Item capacity gives $x+y\\le70$, with $x\\ge0,y\\ge0$." },
          { part: "c", explanation: "The profit function is $P=12x+8y$, to be maximized." },
        ],
      },
    ],
  },
  {
    ...
    subtopic: "Graphing constraints, selecting the feasible side, bounded regions, vertices, and infeasible points",
    mc: [
      {
        questionLatex:
        ...
        choices: ["the side containing the origin", "only the line $x+y=6$", "the side away from the origin", "the whole plane"],
        correctLetter: "A",
        hints: ["Test a simple point.", "The origin gives $0+0\\le6$.", "So the side containing the origin is feasible."],
        solution: [{ step: 1, explanation: "Since $(0,0)$ satisfies $x+y\\le6$, the feasible side is the side containing the origin.", math: "0\\le6" }],
      },
      {
        questionLatex:
          "\\text{The intercepts of the line }x+2y=8\\text{ are}",
        difficulty: 2,
        skillTags: ["graphical_method", "intercepts"],
        choices: ["$(4,0)\\text{ and }(0,8)$", "$(8,0)\\text{ and }(0,4)$", "$(8,0)\\text{ and }(0,2)$", "$(2,0)\\text{ and }(0,4)$"],
        correctLetter: "B",
        hints: ["Set $y=0$ for the $x$-intercept.", "Set $x=0$ for the $y$-intercept.", "The line is $x+2y=8$."],
        solution: [{ step: 1, explanation: "If $y=0$, $x=8$. If $x=0$, $y=4$. The intercepts are $(8,0)$ and $(0,4)$.", math: "(8,0),(0,4)" }],
      },
      {
        questionLatex:
        ...
        choices: ["$2$", "$3$", "$4$", "$5$"],
        correctLetter: "C",
        hints: ["Corner points are vertices of the shaded polygon.", "Count each vertex once.", "The region has four labelled vertices."],
        solution: [{ step: 1, explanation: "The shaded feasible region has vertices $(0,0),(6,0),(4,2),(0,4)$, so it has $4$ corner points.", math: "4" }],
      },
      {
        questionLatex:
        ...
        skillTags: ["feasible_region", "corner_points"],
        figure: feasibleRegionFigure,
        choices: ["$(0,0),(6,0),(4,2),(0,4)$", "$(0,0),(8,0),(0,6)$", "$(6,0),(0,4)$ only", "$(0,0),(4,2)$ only"],
        correctLetter: "A",
        hints: ["Use the axes and the two boundary lines.", "Find the intersection of $x+y=6$ and $x+2y=8$.", "That intersection is $(4,2)$."],
        solution: [{ step: 1, explanation: "The axes give $(0,0),(6,0),(0,4)$, and the two lines intersect at $(4,2)$.", math: "(0,0),(6,0),(4,2),(0,4)" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "D",
        hints: ["Test each point in both inequalities.", "A point must satisfy every constraint.", "Check $x+y\\le6$ for $(5,2)$."],
        solution: [{ step: 1, explanation: "$(5,2)$ gives $5+2=7>6$, so it is not feasible.", math: "5+2=7>6" }],
      },
    ],
    constructed: [
      {
        responseType: "vsaq",
        questionLatex:
          "\\text{Find the intercepts of }2x+y=8.",
        difficulty: 2,
        skillTags: ["graphical_method", "intercepts"],
        parts: singlePart("a", "Find both intercepts.", 2),
        hints: ["Put $y=0$ for one intercept.", "Put $x=0$ for the other.", "Use the equation $2x+y=8$."],
        rubric: singleRubric("a", 2, "Finds intercepts $(4,0)$ and $(0,8)$."),
        commonErrors: ["Interchanging the intercepts of $2x+y=8$ and $x+2y=8$."],
        workedSolution: [{ part: "a", explanation: "When $y=0$, $2x=8$, so $x=4$. When $x=0$, $y=8$. Intercepts are $(4,0)$ and $(0,8)$." }],
      },
      {
        responseType: "vsaq",
        questionLatex:
        ...
        difficulty: 2,
        skillTags: ["feasible_solution", "constraints"],
        parts: singlePart("a", "State whether the point satisfies the inequality.", 2),
        hints: ["Substitute $x=3,y=2$.", "Compute $x+2y$.", "Compare with $8$."],
        rubric: singleRubric("a", 2, "Substitutes and states that the point satisfies the inequality."),
        commonErrors: ["Checking $2x+y$ instead of $x+2y$."],
        workedSolution: [{ part: "a", explanation: "For $(3,2)$, $x+2y=3+4=7\\le8$. Hence the point satisfies the inequality." }],
      },
      {
        responseType: "saq",
        questionLatex:
        ...
        hints: ["Use intercepts on the axes.", "Solve the two line equations together.", "Include the origin."],
        rubric: {
          maxPoints: 3,
          criteria: [
            { part: "a", points: 1, description: "Finds intercept-related vertices." },
            { part: "a", points: 1, description: "Finds intersection $(4,2)$." },
            { part: "a", points: 1, description: "Lists all four vertices." },
          ],
        },
        commonErrors: ["Listing line intercepts that are outside the feasible region."],
        workedSolution: [{ part: "a", explanation: "The corner points are $(0,0),(6,0),(4,2),(0,4)$." }],
      },
      {
        responseType: "laq",
        questionLatex:
        ...
        parts: [
          { letter: "a", promptMarkdown: "Find the intercepts of the two boundary lines.", points: 2 },
          { letter: "b", promptMarkdown: "Find the intersection of the two lines.", points: 2 },
          { letter: "c", promptMarkdown: "List the feasible-region vertices.", points: 1 },
        ],
        hints: ["Use intercepts to draw each line.", "Solve $2x+y=8$ and $x+2y=8$ together.", "Remember the non-negative quadrant."],
        rubric: {
          maxPoints: 5,
          criteria: [
            { part: "a", points: 2, description: "Finds correct intercepts for both lines." },
            { part: "b", points: 2, description: "Finds intersection $\\left(\\frac83,\\frac83\\right)$." },
            { part: "c", points: 1, description: "Lists $(0,0),(4,0),\\left(\\frac83,\\frac83\\right),(0,4)$." },
          ],
        },
        commonErrors: ["Using the wrong side of one inequality.", "Leaving out the origin as a corner point."],
        workedSolution: [
          { part: "a", explanation: "$2x+y=8$ has intercepts $(4,0),(0,8)$; $x+2y=8$ has intercepts $(8,0),(0,4)$." },
          { part: "b", explanation: "Solving $2x+y=8$ and $x+2y=8$ gives $x=y=\\frac83$." },
          { part: "c", explanation: "The feasible region vertices are $(0,0),(4,0),\\left(\\frac83,\\frac83\\right),(0,4)$." },
        ],
      },
      {
        responseType: "case",
        ...
        figure: feasibleRegionFigure,
        parts: [
          { letter: "a", promptMarkdown: "State whether the feasible region is bounded.", points: 1 },
          { letter: "b", promptMarkdown: "List the corner points.", points: 2 },
          { letter: "c", promptMarkdown: "Check whether $(5,1)$ is feasible.", points: 1 },
        ],
        hints: ["A closed polygon in the first quadrant is bounded.", "Read or compute the vertices.", "Substitute $(5,1)$ in both constraints."],
        rubric: {
          maxPoints: 4,
          criteria: [
            { part: "a", points: 1, description: "States bounded." },
            { part: "b", points: 2, description: "Lists all four corner points." },
            { part: "c", points: 1, description: "Shows $(5,1)$ is feasible." },
          ],
        },
        commonErrors: ["Calling a region unbounded because it touches an axis.", "Checking only one constraint for feasibility."],
        workedSolution: [
          { part: "a", explanation: "The feasible region is a closed polygon, so it is bounded." },
          { part: "b", explanation: "The corner points are $(0,0),(6,0),(4,2),(0,4)$." },
          { part: "c", explanation: "For $(5,1)$, $x+y=6\\le6$ and $x+2y=7\\le8$, so the point is feasible." },
        ],
      },
    ],
  },
  {
    ...
    subtopic: "Evaluating objective functions at vertices to find maximum and minimum values",
    mc: [
      {
        questionLatex:
        ...
        correctLetter: "D",
        hints: ["Evaluate $Z$ at every point.", "Compare $0,12,21,25$.", "Choose the largest value."],
        solution: [{ step: 1, explanation: "The values of $Z$ are $0,12,21,25$. The maximum is $25$ at $(0,5)$.", math: "Z(0,5)=25" }],
      },
      {
        questionLatex:
        ...
        difficulty: 2,
        skillTags: ["corner_point_method", "optimization"],
        choices: ["$3\\text{ at }(0,3)$", "$4\\text{ at }(2,0)$", "$10\\text{ at }(4,2)$", "$0\\text{ at }(0,0)$"],
        correctLetter: "A",
        hints: ["Evaluate $C$ at each listed corner point.", "Do not use a point that is not listed.", "Compare $4,3,10$."],
        solution: [{ step: 1, explanation: "$C(2,0)=4$, $C(0,3)=3$, and $C(4,2)=10$. Minimum is $3$ at $(0,3)$.", math: "C_{\\min}=3" }],
      },
      {
        questionLatex:
        ...
        skillTags: ["corner_point_method", "optimization"],
        figure: feasibleRegionFigure,
        choices: ["$30\\text{ at }(6,0)$", "$28\\text{ at }(4,2)$", "$16\\text{ at }(0,4)$", "$0\\text{ at }(0,0)$"],
        correctLetter: "A",
        hints: ["Use the four corner points.", "Evaluate $5x+4y$ at each one.", "The largest value is $30$."],
        solution: [{ step: 1, explanation: "At $(0,0),(6,0),(4,2),(0,4)$, $Z=0,30,28,16$. Maximum is $30$ at $(6,0)$.", math: "Z_{\\max}=30" }],
      },
      {
        questionLatex:
        ...
        choices: ["only $A$ is optimal", "only $B$ is optimal", "every point on segment $AB$ is optimal", "there is no feasible solution"],
        correctLetter: "C",
        hints: ["Equal optimum at adjacent vertices means the objective line is parallel to the edge.", "Linear objective functions are constant along that edge.", "So the entire edge gives the same value."],
        solution: [{ step: 1, explanation: "If adjacent vertices give the same maximum, then every point on the edge joining them also gives that maximum.", math: "\\text{multiple optima on }AB" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "B",
        hints: ["Evaluate $Z$ at all four vertices.", "The values are $0,12,14,12$.", "Choose the largest value."],
        solution: [{ step: 1, explanation: "$Z(0,0)=0$, $Z(6,0)=12$, $Z(4,2)=14$, $Z(0,4)=12$. Maximum occurs at $(4,2)$.", math: "Z(4,2)=14" }],
      },
    ],
    constructed: [
      {
        responseType: "vsaq",
        questionLatex:
          "\\text{Evaluate }Z=4x+3y\\text{ at the point }(5,2).",
        difficulty: 2,
        skillTags: ["corner_point_method", "objective_function"],
        parts: singlePart("a", "Find the value of $Z$.", 2),
        hints: ["Substitute $x=5,y=2$.", "Compute $4(5)+3(2)$.", "Add the two values."],
      ...
      },
      {
        ...
        hints: ["Compare the four numbers.", "The maximum is the largest number.", "Do not average them."],
        rubric: singleRubric("a", 2, "States maximum value $22$."),
        commonErrors: ["Choosing the last listed value instead of the largest value."],
        workedSolution: [{ part: "a", explanation: "The largest of $0,18,22,20$ is $22$." }],
      },
      {
        responseType: "saq",
        questionLatex:
        ...
        difficulty: 3,
        skillTags: ["corner_point_method", "optimization"],
        parts: singlePart("a", "Evaluate $Z$ at all corner points and find the maximum.", 3),
        hints: ["Make a small table of corner points and values.", "Compute $Z=4x+3y$ at each point.", "Choose the largest."],
        rubric: {
          maxPoints: 3,
          criteria: [
            { part: "a", points: 1, description: "Evaluates $Z$ at at least two corner points correctly." },
            { part: "a", points: 1, description: "Evaluates all corner values correctly." },
            { part: "a", points: 1, description: "Finds maximum $20$ at $(5,0)$." },
          ],
        },
        commonErrors: ["Stopping after evaluating the first nonzero corner point."],
        workedSolution: [{ part: "a", explanation: "The values are $0,20,18,12$. Hence the maximum is $20$ at $(5,0)$." }],
      },
      {
        responseType: "laq",
        questionLatex:
        ...
        figure: feasibleRegionFigure,
        parts: [
          { letter: "a", promptMarkdown: "List the corner points of the feasible region.", points: 2 },
          { letter: "b", promptMarkdown: "Evaluate $Z$ at all corner points.", points: 2 },
          { letter: "c", promptMarkdown: "State the maximum value and where it occurs.", points: 1 },
        ],
        hints: ["Use the feasible region from Topic 5.2.", "Evaluate $5x+4y$ at every vertex.", "Compare the values."],
        rubric: {
          maxPoints: 5,
          criteria: [
            { part: "a", points: 2, description: "Lists $(0,0),(6,0),(4,2),(0,4)$." },
            { part: "b", points: 2, description: "Computes $0,30,28,16$." },
            { part: "c", points: 1, description: "States maximum $30$ at $(6,0)$." },
          ],
        },
        commonErrors: ["Evaluating only the intersection point.", "Choosing the largest coordinate instead of largest objective value."],
        workedSolution: [
          { part: "a", explanation: "The corner points are $(0,0),(6,0),(4,2),(0,4)$." },
          { part: "b", explanation: "The corresponding values of $Z=5x+4y$ are $0,30,28,16$." },
          { part: "c", explanation: "Maximum value is $30$, attained at $(6,0)$." },
        ],
      },
      {
        responseType: "case",
        ...
        figure: feasibleRegionFigure,
        parts: [
          { letter: "a", promptMarkdown: "Write the corner points.", points: 1 },
          { letter: "b", promptMarkdown: "Evaluate $Z=3x+5y$ at the corner points.", points: 2 },
          { letter: "c", promptMarkdown: "State the maximum value and the optimal point.", points: 1 },
        ],
        hints: ["Use the four labelled vertices.", "Substitute each vertex in $3x+5y$.", "Choose the largest value."],
        rubric: {
          maxPoints: 4,
          criteria: [
            { part: "a", points: 1, description: "Lists all corner points." },
            { part: "b", points: 2, description: "Computes values $0,18,22,20$." },
            { part: "c", points: 1, description: "Finds maximum $22$ at $(4,2)$." },
          ],
        },
        commonErrors: ["Using the wrong objective from another problem.", "Missing the point $(4,2)$."],
        workedSolution: [
          { part: "a", explanation: "The corner points are $(0,0),(6,0),(4,2),(0,4)$." },
          { part: "b", explanation: "$Z$ values are $0,18,22,20$ respectively." },
  ...
  },
  {
    ...
    subtopic: "Recognising bounded and unbounded regions, checking existence of optimum values, and interpreting multiple optima",
    mc: [
      {
        questionLatex:
        ...
        correctLetter: "A",
        hints: ["Draw the triangle in the first quadrant.", "The axes and line enclose a finite region.", "Finite enclosed region means bounded."],
        solution: [{ step: 1, explanation: "The constraints enclose a triangle with vertices $(0,0),(5,0),(0,5)$, so the region is bounded.", math: "\\text{bounded}" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "B",
        hints: ["The feasible side is away from the origin.", "It continues indefinitely in the first quadrant.", "So it is not enclosed."],
        solution: [{ step: 1, explanation: "The region $x+y\\ge4$ in the first quadrant extends indefinitely, so it is unbounded.", math: "\\text{unbounded}" }],
      },
      {
        questionLatex:
        ...
        figure: multipleOptimaFigure,
        choices: ["only at $(6,0)$", "only at $(0,6)$", "at every point on $x+y=6$ in the first quadrant", "nowhere"],
        correctLetter: "C",
        hints: ["The objective function is parallel to the boundary $x+y=6$.", "At $(6,0)$ and $(0,6)$, $Z=6$.", "Every point on the segment has the same value."],
        solution: [{ step: 1, explanation: "On the edge $x+y=6$, $Z=x+y=6$ at every point, so there are multiple optimal solutions.", math: "Z=6\\text{ on }x+y=6" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "A",
        hints: ["Even an unbounded region can have a minimum.", "Check boundary corner points $(4,0)$ and $(0,4)$.", "Compare $12$ and $8$."],
        solution: [{ step: 1, explanation: "$Z(4,0)=12$ and $Z(0,4)=8$. To prove no smaller value is feasible, note that for every feasible point, $3x+2y=2(x+y)+x\\ge2(4)+0=8$. Thus the open half-plane $3x+2y<8$ has no feasible point, and the minimum is $8$ at $(0,4)$.", math: "Z_{\\min}=8" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "C",
        hints: ["The feasible region is unbounded.", "In the region, $x+y$ can be made larger without limit.", "So a maximum is not attained."],
        solution: [{ step: 1, explanation: "Since $x+y$ can increase indefinitely in the unbounded region, no maximum value exists.", math: "\\text{no maximum}" }],
      },
    ],
    constructed: [
      {
        ...
        hints: ["Substitute the point.", "Check non-negativity.", "$5+1\\ge4$."],
        rubric: singleRubric("a", 2, "States feasible with a valid check."),
        commonErrors: ["Using $\\le$ instead of $\\ge$."],
        workedSolution: [{ part: "a", explanation: "$(5,1)$ satisfies $5+1=6\\ge4$ and both coordinates are non-negative. Hence it is feasible." }],
      },
      {
        responseType: "vsaq",
        questionLatex:
        ...
        hints: ["Think of the objective line moving parallel to itself.", "Equal values at adjacent vertices mean the edge is parallel to the objective line.", "Every point on that edge has the same value."],
        rubric: singleRubric("a", 2, "States that every point on the segment is optimal."),
        commonErrors: ["Choosing only one endpoint as optimal."],
        workedSolution: [{ part: "a", explanation: "Every point on the segment joining $(6,0)$ and $(0,6)$ gives the same maximum value." }],
      },
      {
        responseType: "saq",
        questionLatex:
        ...
        figure: multipleOptimaFigure,
        parts: singlePart("a", "State bounded/unbounded and list the vertices.", 3),
        hints: ["Draw the first quadrant triangle.", "Use intercepts of $x+y=6$.", "Include the origin."],
        rubric: {
          maxPoints: 3,
          criteria: [
            { part: "a", points: 1, description: "States bounded." },
            { part: "a", points: 1, description: "Finds intercept vertices." },
            { part: "a", points: 1, description: "Lists all vertices $(0,0),(6,0),(0,6)$." },
          ],
        },
        commonErrors: ["Forgetting the origin as a vertex."],
        workedSolution: [{ part: "a", explanation: "The region is a bounded triangle with vertices $(0,0),(6,0),(0,6)$." }],
      },
      {
        responseType: "laq",
        questionLatex:
        ...
        parts: [
          { letter: "a", promptMarkdown: "State whether the feasible region is bounded.", points: 1 },
          { letter: "b", promptMarkdown: "Find the minimum value of $Z$.", points: 3 },
          { letter: "c", promptMarkdown: "State whether a maximum exists.", points: 1 },
        ],
        hints: ["The feasible side is away from the origin.", "Check the boundary corner points $(4,0)$ and $(0,4)$.", "For maximum, ask whether $x+y$ can grow without bound."],
        rubric: {
          maxPoints: 5,
          criteria: [
            { part: "a", points: 1, description: "States unbounded." },
            { part: "b", points: 1, description: "Identifies boundary corner points." },
            { part: "b", points: 2, description: "Finds minimum $8$ at $(0,4)$." },
            { part: "c", points: 1, description: "States no maximum exists." },
          ],
        },
        commonErrors: ["Assuming unbounded means no minimum can exist.", "Choosing $(4,0)$ without evaluating both boundary points."],
        workedSolution: [
          { part: "a", explanation: "The feasible region is unbounded." },
          { part: "b", explanation: "At $(4,0)$, $Z=12$; at $(0,4)$, $Z=8$. For the NCERT-style check, for every feasible point $3x+2y=2(x+y)+x\\ge2(4)+0=8$. Therefore the open half-plane $3x+2y<8$ has no common point with the feasible region, so $8$ is the true minimum." },
          { part: "c", explanation: "No maximum exists because $Z=3x+2y$ can be made arbitrarily large in the unbounded region." },
        ],
      },
      {
        responseType: "case",
        ...
        parts: [
          ...
          { letter: "c", promptMarkdown: "Explain whether a maximum cost exists under only these constraints.", points: 1 },
        ],
        hints: ["Use the same boundary corner points.", "Evaluate $C$ at $(4,0)$ and $(0,4)$.", "The region continues indefinitely."],
        rubric: {
          maxPoints: 4,
          criteria: [
            { part: "a", points: 1, description: "States unbounded." },
            { part: "b", points: 2, description: "Finds minimum cost $8$ at $(0,4)$." },
            { part: "c", points: 1, description: "States no maximum exists." },
          ],
        },
        commonErrors: ["Treating the visible drawing window as the whole unbounded region.", "Saying no optimum exists at all."],
        workedSolution: [
          { part: "a", explanation: "The feasible region is unbounded." },
          { part: "b", explanation: "$C(4,0)=12$ and $C(0,4)=8$. Also, for every feasible point, $3x+2y=2(x+y)+x\\ge8$, so $3x+2y<8$ has no feasible point. Hence the minimum cost is $8$." },
          { part: "c", explanation: "There is no maximum cost because the feasible region extends indefinitely and cost can keep increasing." },
        ],
      },
    ],
  },
  {
    ...
    subtopic: "Board-style production, diet, and resource-allocation problems using formulation and corner-point solution",
    mc: [
      {
        questionLatex:
        ...
        correctLetter: "B",
        hints: ["Find the intersection of the two non-axis constraints.", "Evaluate profit at the corner points.", "The intersection is $(20,60)$."],
        solution: [{ step: 1, explanation: "Corner values are $2000$ at $(50,0)$, $2600$ at $(20,60)$, and $2400$ at $(0,80)$. Maximum occurs at $(20,60)$.", math: "P(20,60)=2600" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "C",
        hints: ["Solve the two boundary lines together.", "Compare with axis boundary points.", "At $(3,2)$, cost is $26$."],
        solution: [{ step: 1, explanation: "The lines $x+y=5$ and $2x+y=8$ intersect at $(3,2)$. Costs at relevant boundary corners are $30,32,26$, so the minimum occurs at $(3,2)$.", math: "C(3,2)=26" }],
      },
      {
        questionLatex:
        ...
        choices: ["all points in the plane", "only the axes", "corner points of the feasible region", "only the origin"],
        correctLetter: "C",
        hints: ["A linear objective reaches an optimum at a vertex when an optimum exists.", "This is the corner point method.", "Do not test infinitely many interior points."],
        solution: [{ step: 1, explanation: "The graphical method uses the corner points of the feasible region to find the optimum.", math: "\\text{corner points}" }],
      },
      {
        questionLatex:
        ...
        choices: ["$2x+3y\\le120$", "$3x+2y\\le120$", "$2x+3y\\ge120$", "$x+y\\le120$"],
        correctLetter: "A",
        hints: ["This is a resource limit.", "Multiply product counts by their individual machine hours.", "Available hours form an upper bound."],
        solution: [{ step: 1, explanation: "Total machine hours used are $2x+3y$, so $2x+3y\\le120$.", math: "2x+3y\\le120" }],
      },
      {
        questionLatex:
        ...
        correctLetter: "B",
        hints: ["Evaluate $P$ at the three listed points.", "The values are $2000,2200,2000$.", "Choose the largest."],
        solution: [{ step: 1, explanation: "$P(0,40)=2000$, $P(30,20)=2200$, and $P(50,0)=2000$. Maximum occurs at $(30,20)$.", math: "P(30,20)=2200" }],
      },
    ],
    constructed: [
      {
        ...
        parts: singlePart("a", "Write the profit function.", 2),
        hints: ["Multiply each item by its profit.", "Add the two terms.", "Use $P$ or $Z$."],
        rubric: singleRubric("a", 2, "Writes $P=40x+50y$."),
        commonErrors: ["Writing $40+50$ instead of depending on $x$ and $y$."],
        workedSolution: [{ part: "a", explanation: "The profit function is $P=40x+50y$." }],
      },
      {
        responseType: "vsaq",
        questionLatex:
        ...
        hints: ["Total material used is $2x+3y$.", "Available material is an upper limit.", "Use $\\le$."],
        rubric: singleRubric("a", 2, "Writes $2x+3y\\le90$."),
        commonErrors: ["Using $\\ge$ for a maximum available resource."],
        workedSolution: [{ part: "a", explanation: "The material constraint is $2x+3y\\le90$." }],
      },
      {
        responseType: "saq",
        questionLatex:
        ...
        parts: singlePart("a", "Find the maximum value and the point where it occurs.", 3),
        hints: ["Find the corner points.", "The two non-axis lines intersect at $(6,4)$.", "Evaluate $P$ at all vertices."],
        rubric: {
          maxPoints: 3,
          criteria: [
            { part: "a", points: 1, description: "Finds relevant corner points." },
            { part: "a", points: 1, description: "Evaluates the objective function." },
            { part: "a", points: 1, description: "Finds maximum $240$ at $(6,4)$." },
          ],
        },
        commonErrors: ["Using only intercepts and missing the intersection $(6,4)$."],
        workedSolution: [{ part: "a", explanation: "Corner points are $(0,0),(10,0),(6,4),(0,7)$. Values of $P$ are $0,200,240,210$. Maximum is $240$ at $(6,4)$." }],
      },
      {
        responseType: "laq",
        questionLatex:
        ...
        difficulty: 5,
        skillTags: ["applications", "formulation", "corner_point_method", "optimization"],
        figure: productionRegionFigure,
        parts: [
          { letter: "a", promptMarkdown: "Formulate the LPP.", points: 2 },
          { letter: "b", promptMarkdown: "Find the corner points of the feasible region.", points: 1 },
          { letter: "c", promptMarkdown: "Find the maximum profit and production plan.", points: 2 },
        ],
        hints: ["Machine hours give $2x+3y\\le120$.", "Labour gives $x+y\\le50$.", "Evaluate $P=40x+50y$ at the corner points."],
        rubric: {
          maxPoints: 5,
          criteria: [
            { part: "a", points: 1, description: "Writes correct constraints including non-negativity." },
            { part: "a", points: 1, description: "Writes objective $P=40x+50y$." },
            { part: "b", points: 1, description: "Finds corner points $(0,0),(50,0),(30,20),(0,40)$." },
            { part: "c", points: 2, description: "Finds maximum profit $2200$ at $(30,20)$." },
          ],
        },
        commonErrors: ["Reversing the machine-hour coefficients.", "Choosing $(50,0)$ or $(0,40)$ without checking the intersection."],
        workedSolution: [
          { part: "a", explanation: "Maximize $P=40x+50y$ subject to $2x+3y\\le120$, $x+y\\le50$, $x\\ge0$, $y\\ge0$." },
          { part: "b", explanation: "The feasible region has corner points $(0,0),(50,0),(30,20),(0,40)$." },
          { part: "c", explanation: "Profits are $0,2000,2200,2000$. Maximum profit is Rs. $2200$ at $(30,20)$, so the workshop should make $30$ chairs and $20$ tables." },
        ],
      },
      {
        responseType: "case",
        ...
        difficulty: 4,
        skillTags: ["applications", "formulation", "corner_point_method", "diet_problem", "case_based"],
        figure: dietTableFigure,
        parts: [
          { letter: "a", promptMarkdown: "Write the two nutrient constraints.", points: 1 },
          { letter: "b", promptMarkdown: "Write the cost function to be minimized.", points: 1 },
          { letter: "c", promptMarkdown: "Using relevant corner points $(8,0),(\\frac83,\\frac83),(0,8)$, find the minimum cost.", points: 2 },
        ],
        hints: ["Read protein and vitamin units from the table.", "Diet problems usually use minimum requirements, so use $\\ge$.", "Evaluate cost at the listed corner points."],
        rubric: {
          maxPoints: 4,
          criteria: [
            { part: "a", points: 1, description: "Writes $2x+y\\ge8$ and $x+2y\\ge8$." },
            { part: "b", points: 1, description: "Writes $C=6x+4y$." },
            { part: "c", points: 2, description: "Finds minimum cost $80/3$ at $(\\frac83,\\frac83)$." },
          ],
        },
        commonErrors: ["Using $\\le$ for minimum nutrient requirements.", "Reading nutrient rows as cost values.", "Choosing an axis point without checking the intersection."],
        workedSolution: [
          { part: "a", explanation: "Protein gives $2x+y\\ge8$ and vitamin gives $x+2y\\ge8$, with $x,y\\ge0$." },
          { part: "b", explanation: "The cost function is $C=6x+4y$, to be minimized." },
          { part: "c", explanation: "At $(8,0)$, $C=48$; at $(\\frac83,\\frac83)$, $C=\\frac{80}{3}$; at $(0,8)$, $C=32$. To confirm this is the true minimum, for every feasible point, $6x+4y=\\frac83(2x+y)+\\frac23(x+2y)\\ge\\frac83(8)+\\frac23(8)=\\frac{80}{3}$. So the open half-plane $6x+4y<\\frac{80}{3}$ has no feasible point, and the minimum is attained at $(\\frac83,\\frac83)$." },
        ],
      },
    ],
  },
